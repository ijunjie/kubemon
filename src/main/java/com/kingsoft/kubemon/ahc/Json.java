...
public class Json {
    ...
    private static volatile ObjectMapper objectMapper = null; // NOSONAR

    public static <T> Function<JsonNode, T> cast(Class<T> clazz) {
        return jsonNode -> Json.fromJson(jsonNode, clazz);
    }
    ...
    public static ObjectMapper newDefaultMapper() {
        return JsonMapper.builder()
                .addModules(
                        new Jdk8Module(),
                        new JavaTimeModule(),
                        new ParameterNamesModule()/*,new DefaultScalaModule()*/)
